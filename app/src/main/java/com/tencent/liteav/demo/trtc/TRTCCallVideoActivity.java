 ...
 */
public class TRTCCallVideoActivity extends Activity implements View.OnClickListener, TRTCSettingDialog.ISettingListener {
    private final static String TAG = TRTCCallVideoActivity.class.getSimpleName();

    private boolean bFrontCamera = true, bBeautyEnable = true, bMicEnable = true;
    private int iDebugLevel = 0;

    private TextView tvRoomId , tv_end;
    ...
    private void sendIMMessage(String userName,String message) {
        //构造一条消息并添加一个文本内容
    ...
    private void initView() {
        setContentView(R.layout.call_video_activity);
    ...
    static class TRTCCloudListenerImpl extends TRTCCloudListener {
        private WeakReference<TRTCCallVideoActivity> mContext;
        public TRTCCloudListenerImpl(TRTCCallVideoActivity activity) {
            super();
        ...
        public void onEnterRoom(long elapsed) {
            TRTCCallVideoActivity activity = mContext.get();
            if (activity != null) {

...
public class TRTCLiveActivity extends Activity implements View.OnClickListener, TRTCSettingDialog.ISettingListener {
    private final static String TAG = TRTCLiveActivity.class.getSimpleName();
    ...
    static class TRTCCloudListenerImpl extends TRTCCloudListener {
        ...
        public TRTCCloudListenerImpl(TRTCLiveActivity activity) {
            super();
        ...
        public void onEnterRoom(long elapsed) {
            TRTCLiveActivity activity = mContext.get();
            if (activity != null) {
